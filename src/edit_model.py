...
class pipeline_editor():
    ...
    def open_configs(self, configpath, trainpath, testpath, lablepath, modelpath):
        ...
        pipeline_config.model.faster_rcnn.first_stage_max_proposals = int(self.max_num_boxes * 2.25)
        pipeline_config.model.faster_rcnn.second_stage_batch_size = abs(self.max_num_boxes - 1)
